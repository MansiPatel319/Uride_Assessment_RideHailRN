...
1. **Search for pickup and drop-off locations** using a search bar integrated with the Mapbox Google Search API.
...
1. **Search for Locations:**
   ...
   - Use Mapbox or Google API for location lookup.
...
- Upload your project to a private GitHub repository and invite @sagas29 & @juliusdejon.
